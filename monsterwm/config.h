...
#define FOCUS           "#9dba31" /* focused window border color    */
#define UNFOCUS         "#333333" /* unfocused window border color  */
 ...
 */
static const int initlayouts[] = { FLOAT, BSTACK, GRID, MONOCLE, FLOAT, };
